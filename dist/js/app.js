...
function _start() {
  ...
  regeneratorRuntime.mark(function _callee(location) {
    var context_location, ctx, app;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            context_location = _registry.default[location] || location;
            _context.next = 3;
            return fetch(context_location);

          case 3:
            ctx = _context.sent;
            _context.next = 6;
            return fetch(ctx.entrypoint);
...
},{"./registry":278,"@babel/polyfill":1}],278:[function(require,module,exports){
"use strict";
...
var _default = {
  master: 'https://raw.githubusercontent.com/cognition-app/app/master/cognition.json',
  edge: 'https://raw.githubusercontent.com/cognition-app/app/edge/cognition.json'
};
